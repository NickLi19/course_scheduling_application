...
#     for j in range(K):
#         index = random.randint(j, C)
#         course_list_temp[j], course_list_temp[index] = course_list_temp[index], course_list_temp[j]
#         students_dic[i].append(course_list_temp[j])
#     # students_dic[i] = random.sample(course_list, K)
# end_time = time.time()
...
# start_time = time.time()
# for i in range(1, S+1):
#     course_random_rate = random.sample(course_rate_list, K)
#     first_tiered = 0
#     second_tiered = 0
...
#             second_tiered += 1
#     pivot = int(C / 10) + 1
#     course_first_tiered = random.sample(course_list[:pivot], first_tiered)
#     course_second_tiered = random.sample(course_list[pivot:], second_tiered)
...
#     pivot2 = int(C / 2) + 1
#     pivot3 = int(C * 3 / 4) + 1
#     course_first_tiered = random.sample(course_list[:pivot1], first_tiered)
#     course_second_tiered = random.sample(course_list[pivot1: pivot2], second_tiered)
#     course_third_tiered = random.sample(course_list[pivot2: pivot3], third_tiered)
#     course_fourth_tiered = random.sample(course_list[pivot3:], fourth_tiered)
...
for i in range(1, S+1):
    ...
    course_first_tiered = random.sample(course_list[:pivot1], first_tiered)
    course_second_tiered = random.sample(course_list[pivot1: pivot2], second_tiered)
    course_third_tiered = random.sample(course_list[pivot2:], third_tiered)
